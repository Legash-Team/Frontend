...
export const AboutUs = () => {
  return (
    <section className="py-16 sm:py-24 lg:py-[120px] bg-white" id="about">
      <div className="max-w-[1180px] mx-auto px-4 sm:px-6 md:px-8">
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-20 items-start">
          ...
          <div>
            ...
            <p className="text-base sm:text-lg text-ink-soft leading-relaxed mb-6 sm:mb-8">
            ...
            <div className="mt-6 sm:mt-8 p-5 bg-crimson/[0.04] border border-crimson/10 rounded-2xl max-w-[1180px]">
          ...
          <div className="space-y-8 sm:space-y-12 pt-4 sm:pt-10">
