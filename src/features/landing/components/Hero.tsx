...
export const Hero = () => {
  return (
    <section className="pt-[88px] pb-10 sm:pb-16 overflow-hidden">
      <div className="max-w-[1180px] mx-auto px-4 sm:px-6 md:px-8 grid lg:grid-cols-[1.05fr_0.85fr] gap-10 lg:gap-14 items-center">
        <div>
          <div className="inline-flex items-center gap-2 text-[0.76rem] font-bold text-crimson-dark uppercase mb-4 sm:mb-5">
          ...
          <h1 className="text-[clamp(2.1rem,5vw,3.75rem)] leading-[1.08] text-ink mb-5 sm:mb-6">
            The right blood type,<br />close enough, <em className="italic text-crimson font-serif">in time</em>.
          </h1>
          
          <p className="text-base sm:text-[1.13rem] leading-relaxed text-ink-soft max-w-[46ch] mb-6 sm:mb-8">
          ...
          <div className="flex gap-3.5 flex-wrap mb-8 sm:mb-10">
            <Button 
              variant="primary" 
              size="md" 
              href="/register"
              className="bg-crimson border-2 border-crimson hover:bg-ink hover:border-ink transition-all duration-300 shadow-md w-full sm:w-auto justify-center"
            >
        ...
        {/* Pulse Panel */}
        <div className="relative rounded-[20px] bg-ink p-6 sm:p-8 md:p-[38px_30px_30px] text-paper overflow-hidden shadow-2xl">
